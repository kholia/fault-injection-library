#!/usr/bin/env python3
"""Check the PY32 demo FAILURE marker through a Pico/SimpleGlitcher.

Run this while ``glitch_sweep_py32_gpio.py`` is stopped:

    python3 examples/check_py32_failure_pin.py \
        --port /dev/tty.usbmodemXXXX

The demo wiring is PY32 PA2/package pin 4 (PIN_FAIL) -> glitcher G15/GP15.
The target normally pulses this signal high for 20 ms, followed by about 20 ms
low, on every failed authentication attempt.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Poll GP15 and verify that the PY32 failure marker toggles.",
    ...
    parser.add_argument(
        ...
        type=int,
        default=15,
        help="Pico GPIO connected to PY32 PA2/package pin 4",
    )
...
def main() -> int:
    ...
    print("Expected firmware timing: approximately 20000 us high, 20000 us low")
    ...
    if high_reads and not low_reads:
        ...
        print("FAIL: FAILURE stayed low; check PY32 PA2/pin 4 -> G15 and common ground.")
    else:
